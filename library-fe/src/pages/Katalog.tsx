        ...
        <div className="w-full max-w-4xl">
            ...
            {searchQuery && (
              <p className="text-white text-center mt-5 text-xs md:text-sm italic opacity-90 px-4">
                Menampilkan hasil untuk : <span className="font-bold underline">"{searchQuery}"</span>
              </p>
            )}
        </div>
      </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              {hasActiveFilters && (
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h3 className="text-xs font-bold text-gray-400 uppercase mb-3">Filter Aktif</h3>
